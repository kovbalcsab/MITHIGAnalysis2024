...
inline std::vector<double> EtaEdges18Negative() { return {-5.2, -4.9553636, -4.7497273}; }

inline std::vector<double> EtaEdges18Positive() { return {4.7497273, 4.9553636, 5.2}; }

inline std::vector<double> EtaEdges36Negative() {
  return {-4.7497273, -4.5736364, -4.3987273, -4.2238182, -4.0477273, -3.8728182,
          -3.6979091, -3.523,     -3.3480909, -3.1731818, -3.0136364, -2.8};
}

inline std::vector<double> EtaEdges36Positive() {
  return {2.8,       3.0136364, 3.1731818, 3.3480909, 3.523,     3.6979091,
          3.8728182, 4.0477273, 4.2238182, 4.3987273, 4.5736364, 4.7497273};
}
