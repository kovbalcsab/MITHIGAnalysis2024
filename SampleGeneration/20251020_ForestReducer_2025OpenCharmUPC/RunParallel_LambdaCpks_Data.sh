...
# =============================================================================
# SKIM FOR: LAMBDA_C -> P + K_S -> PI + PI

# Input settings:
YEAR=2023
ISDATA=true
TAG="LambdaCpks_2023Data_Feb2025ReReco_HIForward0"
...
# Output Settings:
OUTPUT="/data00/jdlang/UPCLambdaCAnalysis/SkimsData/output_${TAG}_${DATE}"
MERGEDOUTPUT="/data00/jdlang/UPCLambdaCAnalysis/SkimsData/${TAG}_${DATE}.root"
