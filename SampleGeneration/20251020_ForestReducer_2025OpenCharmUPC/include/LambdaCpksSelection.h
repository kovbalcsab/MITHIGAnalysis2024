...
bool DCutSelection(
  LambdaCpksTreeMessenger &MLambdaC,
  int iD,
  ...
  vector<vector<float>> DRestrk1PtCutValue,
  vector<vector<float>> DRestrk2PtCutValue
) {
  ...
  if (
    ...
    CheckCut(DRestrk1PtCutValue,  MLambdaC.DRestrk1Pt[iD],  pt, y) &&
    CheckCut(DRestrk2PtCutValue,  MLambdaC.DRestrk2Pt[iD],  pt, y)
  ) {
    pass = true;
  }
  return pass;
...
// Use same settings for Dtrk2 & DRestrk1 as Dtrk1:
...
vector<vector<float>> DRestrk1PtCutValue_nom    = Dtrk1PtCutValue_nom;
vector<vector<float>> DRestrk1PtCutValue_syst   = Dtrk1PtCutValue_syst;
vector<vector<float>> DRestrk1PtCutValue_loose  = Dtrk1PtCutValue_loose;
vector<vector<float>> DRestrk2PtCutValue_nom    = Dtrk2PtCutValue_nom;
vector<vector<float>> DRestrk2PtCutValue_syst   = Dtrk2PtCutValue_syst;
vector<vector<float>> DRestrk2PtCutValue_loose  = Dtrk2PtCutValue_loose;

bool DpassCutNominal(LambdaCpksTreeMessenger &MLambdaC, int iD) {
  return DCutSelection(
    ...
    Dtrk1PtCutValue_nom,
    Dtrk2PtCutValue_nom,
    DRestrk1PtCutValue_nom,
    DRestrk2PtCutValue_nom
  );
}

bool DpassCutLoose(LambdaCpksTreeMessenger &MLambdaC, int iD) {
  return DCutSelection(
    MLambdaC,
    iD,
    ...
    DRestrk1PtCutValue_loose,
    DRestrk2PtCutValue_loose
  );
}

bool DpassCutSystDsvpvSig(LambdaCpksTreeMessenger &MLambdaC, int iD) {
  return DCutSelection(
    MLambdaC,
    iD,
    Dchi2clCutValue_nom,
...
bool DpassCutSystDtrkPt(LambdaCpksTreeMessenger &MLambdaC, int iD) {
  return DCutSelection(
    MLambdaC,
    iD,
    Dchi2clCutValue_nom,
    ...
    DRestrk1PtCutValue_syst,
    DRestrk2PtCutValue_syst
  );
}

bool DpassCutSystDalpha(LambdaCpksTreeMessenger &MLambdaC, int iD) {
  return DCutSelection(
    MLambdaC,
    iD,
    Dchi2clCutValue_nom,
...
bool DpassCutSystDdtheta(LambdaCpksTreeMessenger &MLambdaC, int iD) {
  return DCutSelection(
    MLambdaC,
    iD,
    Dchi2clCutValue_nom,
...
// Added to apply systematics for Dalpha and Ddtheta indendently:
bool DpassCutSystDalphaDdtheta(LambdaCpksTreeMessenger &MLambdaC, int iD) {
  return DCutSelection(
    MLambdaC,
    iD,
    Dchi2clCutValue_nom,
...
bool DpassCutSystDchi2cl(LambdaCpksTreeMessenger &MLambdaC, int iD) {
  return DCutSelection(
    MLambdaC,
    iD,
