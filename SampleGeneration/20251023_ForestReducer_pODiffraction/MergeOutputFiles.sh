...
FOLDER_IDX=(1 2 3 4 5)
FILE_IDX=(1 2 3 4 5 6 7 8 9)
# Merging ROOT files using hadd

for folder in "${FOLDER_IDX[@]}"; do
    for file in "${FILE_IDX[@]}"; do
        input_files="/data00/bakovacs/pOsamples/Skims/output_2025102*_Skim_test_pO_sample_000${folder}/output_${file}*.root"
        ...
        if [ "$file" -eq 1 ]; then
            input_files="/data00/bakovacs/pOsamples/Skims/output_2025102*_Skim_test_pO_sample_000${folder}/output_0.root $input_files"
        fi
