#ifndef PODIFFRACTIVEFSCANDPPSPARSEFUNCS
#define PODIFFRACTIVEFSCANDPPSPARSEFUNCS

void fillFSCInfo(pODiffractiveTreeMessenger &MCH, FSCTreeMessenger &MFSC, int n) {
...
void fillPPSInfo(pODiffractiveTreeMessenger &MCH, PPSTreeMessenger &MPPS, int n) {
