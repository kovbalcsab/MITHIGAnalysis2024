...
SOURCE_DIR="/store/group/phys_heavyions/jdlang/run3_2023Data_Dec2024ReReco"
# Output of skimmed files (use xrootd path)
OUTPUT_SERVER="root://eoscms.cern.ch/"
OUTPUT_DIR="/store/group/phys_heavyions/$USER/run3_2023Data_Dec2024ReReco_Skims_$DATE"
