    ...
    for (int i = 1; i < argc; ++i) {
        ...
        if (arg == "--help") {
           std::cout << "Usage: " << argv[0] << " [OPTIONS]\n"
              << "Options:\n"
              << "  --MinDPT <value>       Minimum D particle transverse momentum threshold for event selection.\n"
              << "  --MaxDPT <value>       Maximum D particle transverse momentum threshold for event selection.\n"
              << "  --MinDY <value>        Minimum D particle rapidity threshold for event selection.\n"
              << "  --MaxDY <value>        Maximum D particle rapidity threshold for event selection.\n"
/*
