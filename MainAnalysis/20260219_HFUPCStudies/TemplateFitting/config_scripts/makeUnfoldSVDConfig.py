...
SampleFileTag = "SVD_MC_unfolding_ybinned"
SampleFileName = f"TemplateFitting/SampleConfigs/UnfoldSVD_{SampleFileTag}.json"
...
#        "OutputFileName": f"{OutputFileDir}/unfolding_HFEMaxMinus_forest_SVD.root",
#        "XMin": 0,
#        "XMax": 200,
#        "BinsPerGeV": 4,
#        "Iterations": 10,
...
#        "OutputFileName": f"{OutputFileDir}/unfoldingMC_HFEMaxPlus_forest_SVD.root",
#        "XMin": 0,
#        "XMax": 200,
#        "BinsPerGeV": 4,
#        "Iterations": 10,
...
#        "VarDataName": "HFEMaxPlus_forest",
#        "VarNoiseName": "HFEMaxPlus_forest",
#        "OutputFileName": f"{OutputFileDir}/unfolding_HFEMaxPlus_forest_SVD.root",
#        "XMin": 0,
#        "XMax": 200,
#        "BinsPerGeV": 4,
#        "Iterations": 10,
...
for pt_y_bins in PtYBins:
    OutputFilesArray.append({
        ...
        "VarDataName": "HFEMaxPlus_forest",
        "VarNoiseName": "HFEMaxPlus_forest",
        "OutputFileName": f"{OutputFileDir}/unfoldingMC_HFEMaxPlus_forest_SVD_pt{pt_y_bins[0]}-{pt_y_bins[1]}_y{pt_y_bins[2]}-{pt_y_bins[3]}.root",
        "XMin": 0,
        "XMax": 200,
        "BinsPerGeV": 4,
        "Iterations": 10,
...
#        "VarDataName": "HFEMaxPlus_forest",
#        "VarNoiseName": "HFEMaxPlus_forest",
#        "OutputFileName": f"{OutputFileDir}/unfolding_HFEMaxPlus_forest_SVD_pt{pt_y_bins[0]}-{pt_y_bins[1]}_y{pt_y_bins[2]}-{pt_y_bins[3]}.root",
#        "XMin": 0,
#        "XMax": 200,
#        "BinsPerGeV": 4,
#        "Iterations": 10,
...
#        "VarDataName": "HFEMaxMinus_forest",
#        "VarNoiseName": "HFEMaxMinus_forest",
#        "OutputFileName": f"{OutputFileDir}/unfolding_HFEMaxMinus_forest_SVD_pt{pt_y_bins[0]}-{pt_y_bins[1]}_y{pt_y_bins[2]}-{pt_y_bins[3]}.root",
#        "XMin": 0,
#        "XMax": 200,
#        "BinsPerGeV": 4,
#        "Iterations": 10,
