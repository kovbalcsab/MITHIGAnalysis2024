...
int main(int argc, char** argv) {
    ...
    TH2D* hMassvsEta = new TH2D("hMassvsEta", "Two track Mass vs Eta;Mass (GeV/c^{2});#eta;Entries", 480, 0.8, 2, 100, -2.4, 2.4);
    TH2D* hMassvsPt = new TH2D("hMassvsPt", "Two track Mass vs p_{T};Mass (GeV/c^{2});p_{T} (GeV/c);Entries", 480, 0.8, 2, 100, 0, 5);
    TH3D* hMassvsPtvsEta = new TH3D("hMassvsPtvsEta", "Two track Mass vs p_{T} vs Eta;Mass (GeV/c^{2});p_{T} (GeV/c);#eta;Entries", 480, 0.8, 2, 100, 0, 5, 100, -2.4, 2.4);
    ...
    TH1F* hFSC2bottomM_chargefC = new TH1F("hFSC2bottomM_chargefC", "FSC2 Bottom Charge;Charge (fC);Entries", 5000, 0, 40000);
    TH1F* hFCS2topM_chargefC = new TH1F("hFCS2topM_chargefC", "FSC2 Top Charge;Charge (fC);Entries", 5000, 0, 40000);
    TH1F* hFSC3bottomleftM_chargefC = new TH1F("hFSC3bottomleftM_chargefC", "FSC3 Bottom Left Charge;Charge (fC);Entries", 5000, 0, 40000);
    TH1F* hFSC3bottomrightM_chargefC = new TH1F("hFSC3bottomrightM_chargefC", "FSC3 Bottom Right Charge;Charge (fC);Entries", 5000, 0, 40000);
    TH1F* hFSC3topleftM_chargefC = new TH1F("hFSC3topleftM_chargefC", "FSC3 Top Left Charge;Charge (fC);Entries", 5000, 0, 40000);
    TH1F* hFSC3toprightM_chargefC = new TH1F("hFSC3toprightM_chargefC", "FSC3 Top Right Charge;Charge (fC);Entries", 5000, 0, 40000);
